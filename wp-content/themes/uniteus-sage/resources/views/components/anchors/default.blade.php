                            ...
                            <li :class="showSlide == '{{ $index }}' ? 'active-anchor' : ''" class="anchor-li"
                                ...
                                <a href="#{{ $anchor }}"
                                    ...
                                    @isset($card['icon']['sizes'])
                                        <img class="w-12 h-12 object-contain" src="{{ $card['icon']['sizes']['medium'] }}"
                                            alt="" />
                                    @endisset
                                    {{ $card['title'] }}
                                </a>
                ...
                <div class="col-span-9 flex flex-col gap-32">
                    @foreach ($cards as $index => $card)
                        ...
                        <div id="{{ $anchor }}"
                            ...
                            <div
                                class="group relative flex flex-col-reverse sm:flex-row sm:justify-between sm:items-end mb-10 gap-10">
                                <h2 class="mb-0 text-4xl">{{ $card['title'] }}</h2>
                                @isset($card['icon']['sizes'])
                                    <img class="group-hover:icon-gray w-40 h-auto object-contain sm:absolute right-0 bottom-0"
                            ...
                            <div
                                class="flex flex-col @if ($card['stats'] && $card['articles']) md:grid md:grid-cols-12 @endif gap-12 mt-10">
                                @if ($card['stats'])
