        ...
        <div class="flex flex-col md:gap-10 md:grid md:grid-cols-12">
            ...
            <div class="relative md:col-span-6 order-1 md:order-2 -mx-8 sm:mx-auto">
                @if ($event_info['hero_image'])
                    <div class="relative">
                        @if ($event_info['video'])
                            <img class="relative z-10 w-full h-full object-contain"
                                src="{{ $event_info['hero_image']['sizes']['medium_large'] }}"
                                alt="{{ $event_info['hero_image']['alt'] }}">
                            <div class="absolute inset-0 overflow-hidden" style="margin-left: 2px; margin-right: 2px;">

                                <div class="relative responsive-embed"
                                    style="border-radius: 0;margin-top: 18%; transform: scale(1.2); transform-origin: center;">
                                    {!! $event_info['video'] !!}
                                </div>
                            ...
                            <div class="mt-6 flex">
                                <div class="mr-4 flex-shrink-0 pt-2">
                                    <svg width="17" height="20" viewBox="0 0 17 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M13.7422 2.92334C16.8859 6.06706 16.8859 11.164 13.7422 14.3078L8.04999 20L2.35779 14.3078C-0.785929 11.164 -0.785929 6.06706 2.35779 2.92334C5.5015 -0.220378 10.5985 -0.220379 13.7422 2.92334ZM8.05024 10.9155C9.32049 10.9155 10.3502 9.88574 10.3502 8.61549C10.3502 7.34523 9.32049 6.31549 8.05024 6.31549C6.77998 6.31549 5.75024 7.34523 5.75024 8.61549C5.75024 9.88574 6.77998 10.9155 8.05024 10.9155Z"
                                            fill="#216CFF" />
                                    </svg>
                        ...
                        <div class="mt-6 flex">
                            <div class="mr-4 flex-shrink-0 pt-2">
                                ...
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        d="M7.76499 16C12.0535 16 15.53 12.5235 15.53 8.23498C15.53 3.94649 12.0535 0.469971 7.76499 0.469971C3.47651 0.469971 0 3.94649 0 8.23498C0 12.5235 3.47651 16 7.76499 16ZM8.73562 4.35248C8.73562 3.81641 8.30106 3.38185 7.76499 3.38185C7.22893 3.38185 6.79437 3.81641 6.79437 4.35248V8.23498C6.79437 8.49241 6.89663 8.73929 7.07866 8.92132L9.824 11.6667C10.2031 12.0457 10.8176 12.0457 11.1967 11.6667C11.5757 11.2876 11.5757 10.673 11.1967 10.294L8.73562 7.83294V4.35248Z"
                                        fill="#216CFF" />
                                </svg>
                    ...
                    @if ($registration_open)
                        @isset($event_info['about_button_link'])
                            <div class="mt-6 inline-flex rounded-md shadow">
                                <a href="{{ $event_info['about_button_link'] }}" class="button button-solid !py-2 !px-6"
                                    style="border-color: {{ $event_info['about_button_color'] }}; background-color: {{ $event_info['about_button_color'] }}">
