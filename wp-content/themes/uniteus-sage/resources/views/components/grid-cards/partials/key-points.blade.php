...
<div class="component-inner-section mb-10">
  <div class="flex flex-col gap-0 lg:gap-8 @if (count($key_points) > 1) md:grid md:grid-cols-2 lg:grid-cols-{{ count($key_points) }} @endif">
    @foreach ($key_points as $point)
      <div class="flex top-gradient-line flex-col justify-between gap-8 p-8 lg:px-0">
