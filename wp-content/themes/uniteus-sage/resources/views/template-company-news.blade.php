{{--
  Template Name: Press - Company News 
--}}
{{--
        ...
        <div class="component-inner-section">
            ...
            <div id="kh-top" class="mb-8">
                <div id="kh-filters" class="ajax-filters kh-filters relative z-20">
                    @php
                        echo do_shortcode('[searchandfilter slug="studies-data-copy"]');
                    @endphp
                </div>
            </div>
            ...
            <div id="kh-search-results">
                ...
                {!! do_shortcode('[searchandfilter slug="studies-data-copy" show="results"]') !!}

            </div>
        </div>
    </section>
    <section id="" class="relative component-section relative bg-white  padding-collapse ">
